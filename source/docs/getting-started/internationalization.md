...
If you would like to customize the default translation, you do not need to modify the translation files in the `languages` directory. You can override all translations using [Data files](/docs/getting-started/configuration.html).
